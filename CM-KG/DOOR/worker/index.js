...
const TOOLS = [
  ...
  { name: 'get_record', title: 'Get Capital Markets Record', annotations: { title: 'Get Capital Markets Record', ...ANN }, description: 'Return the full Capital Markets Record for an issuer, with per-field source, reader and state; optionally a prior version.',
    inputSchema: { type: 'object', properties: { identifier: { type: 'string', description: 'Ticker, ISIN, LEI, or a CMR key such as ca-cm-kg/TSX/SHOP, uk-cm-kg/LSE/SHEL, au-cm-kg/ASX/BHP, sg-cm-kg/SGX/D05, ch-cm-kg/SIX/NESN, de-cm-kg/XETRA/SAP, fr-cm-kg/XPAR/FR0000120271 or nl-cm-kg/XAMS/NL0000009165.' }, version: { type: 'integer', description: 'Prior version number; omitted = current.' } }, required: ['identifier'] } },
...
const HOST_NODE = { 'mcp.ca-cm-kg.ai': 'ca-cm-kg', 'mcp.uk-cm-kg.ai': 'uk-cm-kg', 'mcp.au-cm-kg.ai': 'au-cm-kg', 'mcp.sg-cm-kg.ai': 'sg-cm-kg', 'mcp.ch-cm-kg.ai': 'ch-cm-kg', 'mcp.de-cm-kg.ai': 'de-cm-kg', 'mcp.fr-cm-kg.ai': 'fr-cm-kg', 'mcp.nl-cm-kg.ai': 'nl-cm-kg' };
...
const SUFFIX = { TO: ['TSX'], V: ['TSXV'], CN: ['CSE'], C: ['CSE'], NE: ['CBOE-CANADA'], CB: ['CBOE-CANADA'], L: ['LSE', 'AIM'], LN: ['LSE', 'AIM'], AQ: ['AQSE'], AX: ['ASX'], AU: ['ASX'], NS: ['NSX'], SI: ['SGX', 'SGX-CATALIST'], SG: ['SGX', 'SGX-CATALIST'], SW: ['SIX'], VX: ['SIX'], BX: ['BX'], DE: ['XETRA'], F: ['XETRA'], XE: ['XETRA'], PA: ['XPAR', 'ALXP', 'XMLI'], AS: ['XAMS', 'ALXA'], NA: ['XAMS', 'ALXA'] };
const PREFIX = { TSX: 'TSX', TSXV: 'TSXV', 'TSX-V': 'TSXV', CVE: 'TSXV', CSE: 'CSE', CNSX: 'CSE', CNQ: 'CSE', NEO: 'CBOE-CANADA', CBOE: 'CBOE-CANADA', 'CBOE-CANADA': 'CBOE-CANADA', LSE: 'LSE', LON: 'LSE', MAIN: 'LSE', AIM: 'AIM', AQSE: 'AQSE', AQUIS: 'AQSE', NEX: 'AQSE', ASX: 'ASX', XASX: 'ASX', NSX: 'NSX', XNEC: 'NSX', SGX: 'SGX', XSES: 'SGX', SES: 'SGX', MAINBOARD: 'SGX', CATALIST: 'SGX-CATALIST', 'SGX-CATALIST': 'SGX-CATALIST', SIX: 'SIX', SWX: 'SIX', XSWX: 'SIX', VTX: 'SIX', BX: 'BX', XBRN: 'BX', XETRA: 'XETRA', XETR: 'XETRA', ETR: 'XETRA', FRA: 'XETRA', FWB: 'XETRA', DE: 'XETRA', EUREX: 'EUREX', XEUR: 'EUREX', XPAR: 'XPAR', EPA: 'XPAR', PAR: 'XPAR', ENXTPA: 'XPAR', EURONEXT: 'XPAR', 'EURONEXT-PARIS': 'XPAR', ALXP: 'ALXP', 'EURONEXT-GROWTH': 'ALXP', XMLI: 'XMLI', 'EURONEXT-ACCESS': 'XMLI', XAMS: 'XAMS', AMS: 'XAMS', AEX: 'XAMS', ENXTAM: 'XAMS', 'EURONEXT-AMSTERDAM': 'XAMS', ALXA: 'ALXA' };
const EX_NODE = { TSX: 'ca-cm-kg', TSXV: 'ca-cm-kg', CSE: 'ca-cm-kg', 'CBOE-CANADA': 'ca-cm-kg', LSE: 'uk-cm-kg', AIM: 'uk-cm-kg', AQSE: 'uk-cm-kg', ASX: 'au-cm-kg', NSX: 'au-cm-kg', SGX: 'sg-cm-kg', 'SGX-CATALIST': 'sg-cm-kg', SIX: 'ch-cm-kg', BX: 'ch-cm-kg', XETRA: 'de-cm-kg', EUREX: 'de-cm-kg', XPAR: 'fr-cm-kg', ALXP: 'fr-cm-kg', XMLI: 'fr-cm-kg', XAMS: 'nl-cm-kg', ALXA: 'nl-cm-kg' };
...
function human(host, node) {
  const c = NODE_COPY[node] || { title: 'Capital Markets Knowledge Graph — global door', scope: `Routes by identifier to the node that holds the name. Live today: ${liveNodes().join(', ')}.`, example: 'uk-cm-kg/LSE/SHEL', exchanges: 'per node', ids: 'SHOP, SHEL, SHEL.L, AIM:4BB, BHP.AX, D05.SI, NESN.SW, SAP.DE, FR0000120271, NL0000009165' };
