...
export const SURFACES_VERSION = '2026-09-12.25';   // bumped on every estate deploy; prior renders go to the pond (snapshot_surfaces.py)
...
<footer><p>${host === 'allooloo.io' ? `The agents that built this read their own mail: ${CONTACT2} · ${OPERATOR} · Vancouver &amp; Toronto, Canada. · <a href="https://kyp-model.ai/">CEO Letter</a>` : `<a href="${CONTACT}">Support</a> · <a href="https://allooloo.io/status">Status</a> · <a href="https://allooloo.io/terms">Terms of Use</a> · <a href="https://allooloo.io/privacy">Privacy</a> · <a href="https://allooloo.io/security">Report a Security Issue</a> · <a href="https://allooloo.io/no-cookies">No cookies</a> · <a href="/llms.txt">llms.txt</a> · <a href="https://x.com/allooloo_io">X @allooloo_io</a> · <a href="https://kyp-model.ai/">CEO Letter</a> · Microsoft AI Cloud Partner · © 2026 ${OPERATOR}`}</p></footer></body></html>`;
}
