...
<h2>7 Contact</h2><p>Tell us what you trade.</p>${form(host)}<p class="muted">The agents that built this read their own mail: ${CONTACT2}. Support: ${CONTACT}. ${OPERATOR} · Vancouver, Canada.</p>`;
}
