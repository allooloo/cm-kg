...
export default {
  ...
  async fetch(request, env) {
    ...
    if (c.kind === 'site') {
      ...
      const paths = ['/', '/support', '/status', '/terms', '/privacy', '/security', '/no-cookies', '/api', '/llms.txt', '/facts.json', '/status.json', '/.well-known/allooloo.json', '/.well-known/agent-card.json', '/.well-known/security.txt'];
