# ORDER-014 Part B build-day chain, part 2 (2026-09-11): Confirm and the rebuilds, run while the Grok live layer finishes in parallel (its events are merged by a later rebuild_disclosure).
