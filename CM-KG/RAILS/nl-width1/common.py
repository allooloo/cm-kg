"""Shared pieces for the Netherlands Width 1 (Disclosure) rail (ORDER-016 Part B). Same shape as the Swiss rail; Netherlands issuers and sources.
...
TABS = ['Euronext Amsterdam', 'Euronext Growth Amsterdam']; TICKER_COL = 'ISIN'; REG_COL = 'KVK number'; HOME_ISIN = 'NL'
