"""Shared pieces for the South Korea Fill + Confirm rail (passes 2 and 3). Same shape as the UK rail; South Korea pockets. Pond-native:
raw\\ is a junction to the open drop POND\\kr-cm-kg\\fill-confirm\\<date>\\; jload reads every drop (newest wins per key)."""
import os, sys, re, json, time, threading, html, datetime
import requests, openpyxl
sys.path.insert(0, r'C:\ALLOOLOO\CM-KG\RAILS\kr-width1'); sys.path.insert(0, r'C:\ALLOOLOO\CM-KG\RAILS\kr-width0')
import keys
import pond
...
NODE = 'kr-cm-kg'
ISSUERS_XLSX = pond.latest_assembled(NODE, 'kr-issuers.xlsx') or r'C:\ALLOOLOO\CM-KG\ISSUERS\kr-issuers.xlsx'
EVENTS_JSONL = pond.latest_assembled(NODE, 'kr-events.jsonl') or r'C:\ALLOOLOO\CM-KG\DISCLOSURE\events\kr-events.jsonl'
