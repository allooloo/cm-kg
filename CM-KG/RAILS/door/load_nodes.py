...
JP = {'tabs': {'Prime Market': 'TSE-PRIME', 'Standard Market': 'TSE-STANDARD', 'Growth Market': 'TSE-GROWTH', 'PRO Market': 'TSE-PRO', 'REITs and funds': 'TSE-REIT'}, 'ticker': 'Symbol', 'name': 'Legal name (English, as published)', 'default_as_of': '2026-09-12',
      'fields': {'name': ('Legal name (English, as published)', 'Roster source', 'Roster read by', None, None), 'name_native': ('Legal name (Japanese)', 'Register source', 'Register read by', None, None), 'name_kana': ('Name (kana)', 'Register source', 'Register read by', None, None), 'ticker': ('Symbol', 'Roster source', 'Roster read by', None, None), 'exchange': ('Exchange', 'Roster source', 'Roster read by', None, None), 'market_section': ('JPX section', 'Roster source', 'Roster read by', None, None), 'index_size': ('Size (TOPIX index series)', 'Roster source', 'Roster read by', None, None),
                 'security_type': ('Security type', 'Roster source', 'Roster read by', None, None), 'isin': ('ISIN', 'ISIN source', 'ISIN read by', 'ISIN State', 'ISIN'), 'lei': ('LEI', 'LEI source', 'LEI read by', 'LEI State', 'LEI'), 'lei_registration_status': ('LEI registration status', 'LEI source', 'LEI read by', None, 'LEI'),
                 'jurisdiction': ('Incorporation jurisdiction', 'Jurisdiction source', 'Jurisdiction read by', 'Jurisdiction State', 'Incorporation jurisdiction'), 'sector': ('Sector', 'Sector source', 'Sector read by', 'Sector State', 'Sector'),
                 'auditor': ('Auditor', 'Auditor source', 'Auditor read by', 'Auditor State', 'Auditor'), 'annual_report': ('Annual report', 'Annual report source', 'Annual report read by', None, 'Annual report'), 'accounts_period_end': ('Accounts period end', 'Auditor source', 'Auditor read by', None, None), 'going_concern': ('Going concern (annual report)', 'Auditor source', 'Auditor read by', None, None),
                 'registrar': ('Share registrar', 'Share registrar source', 'Share registrar read by', 'Share registrar State', 'Share registrar'), 'newswire': ('Newswire of habit', 'Newswire releases seen', 'Newswire read by', 'Newswire State', 'Newswire of habit'),
                 'hq_city': ('HQ city', 'HQ source', 'HQ read by', 'HQ State', 'HQ city'), 'status': ('Status', 'Roster source', 'Roster read by', None, None),
                 'corporate_number': ('Corporate number (法人番号)', 'Register source', 'Register read by', 'Register State', 'Corporate number (法人番号)'), 'edinet_code': ('EDINET code', 'Register source', 'Register read by', None, 'EDINET code'), 'filer_type': ('Filer type (EDINET)', 'Register source', 'Register read by', None, None), 'capital_jpy_m': ('Capital (JPY million, EDINET)', 'Register source', 'Register read by', None, None), 'fiscal_year_end': ('Fiscal year end (EDINET)', 'Register source', 'Register read by', None, None),
                 'registered_office': ('Registered office (EDINET address, Japanese)', 'Registered office source', 'Registered office read by', 'Registered office State', 'Registered office'), 'sector_17': ('Sector (17)', 'Sector source', 'Sector read by', None, None), 'industry_native': ('Industry (EDINET, Japanese)', 'Register source', 'Register read by', None, None)},
      'second': {'isin': 'ISIN', 'lei': 'LEI', 'corporate_number': 'Corporate number (法人番号)', 'registrar': 'Share registrar', 'auditor': 'Auditor', 'newswire': 'Newswire of habit'}, 'prefixes': ['TSE-PRIME', 'TSE-STANDARD', 'TSE-GROWTH', 'TSE-PRO', 'TSE-REIT'], 'alias_from_lei_record': True}
KR = {'tabs': {'KOSPI': 'KOSPI', 'KOSDAQ': 'KOSDAQ', 'KONEX': 'KONEX'}, 'ticker': 'Symbol', 'name': 'Legal name (English, DART)', 'default_as_of': '2026-09-12',
      'fields': {'name': ('Legal name (English, DART)', 'Register source', 'Register read by', None, None), 'name_native': ('Legal name (Korean)', 'Roster source', 'Roster read by', None, None), 'stock_name': ('Stock name (DART)', 'Register source', 'Register read by', None, None), 'ticker': ('Symbol', 'Roster source', 'Roster read by', None, None), 'exchange': ('Exchange', 'Roster source', 'Roster read by', None, None),
                 'security_type': ('Security type', 'Roster source', 'Roster read by', None, None), 'isin': ('ISIN', 'ISIN source', 'ISIN read by', 'ISIN State', 'ISIN'), 'lei': ('LEI', 'LEI source', 'LEI read by', 'LEI State', 'LEI'), 'lei_registration_status': ('LEI registration status', 'LEI source', 'LEI read by', None, 'LEI'),
                 'jurisdiction': ('Incorporation jurisdiction', 'Jurisdiction source', 'Jurisdiction read by', 'Jurisdiction State', 'Incorporation jurisdiction'), 'sector': ('Sector', 'Sector source', 'Sector read by', 'Sector State', 'Sector'),
                 'auditor': ('Auditor', 'Auditor source', 'Auditor read by', 'Auditor State', 'Auditor'), 'annual_report': ('Annual report', 'Annual report source', 'Annual report read by', None, 'Annual report'), 'accounts_period_end': ('Accounts period end', 'Auditor source', 'Auditor read by', None, None), 'going_concern': ('Going concern (annual report)', 'Auditor source', 'Auditor read by', None, None),
                 'registrar': ('Share registrar', 'Share registrar source', 'Share registrar read by', 'Share registrar State', 'Share registrar'), 'newswire': ('Newswire of habit', 'Newswire releases seen', 'Newswire read by', 'Newswire State', 'Newswire of habit'),
                 'hq_city': ('HQ city', 'HQ source', 'HQ read by', 'HQ State', 'HQ city'), 'status': ('Status', 'Roster source', 'Roster read by', None, None),
                 'corporate_registration_number': ('Corporate registration number (법인등록번호)', 'Register source', 'Register read by', 'Register State', 'Corporate registration number (법인등록번호)'), 'business_registration_number': ('Business registration number (사업자등록번호)', 'Register source', 'Register read by', 'Register State', 'Business registration number (사업자등록번호)'), 'dart_corp_code': ('DART corp code', 'Register source', 'Register read by', None, 'DART corp code'), 'corp_class': ('Corp class (DART)', 'Register source', 'Register read by', None, None), 'establishment_date': ('Establishment date (DART)', 'Register source', 'Register read by', None, None), 'fiscal_month': ('Fiscal month', 'Roster source', 'Roster read by', None, None),
                 'registered_office': ('Registered office (DART address, Korean)', 'Registered office source', 'Registered office read by', 'Registered office State', 'Registered office'), 'industry_code': ('Industry code (DART, KSIC)', 'Register source', 'Register read by', None, None), 'main_products_native': ('Main products (KIND, Korean)', 'Roster source', 'Roster read by', None, None), 'region_native': ('Region (KIND)', 'Roster source', 'Roster read by', None, None), 'listing_date': ('Listing date', 'Listing date source', 'Roster read by', None, 'Listing date'), 'website': ('Website', 'Roster source', 'Roster read by', None, None), 'ir_page': ('IR page', 'Register source', 'Register read by', None, None)},
      'second': {'isin': 'ISIN', 'lei': 'LEI', 'business_registration_number': 'Business registration number (사업자등록번호)', 'registrar': 'Share registrar', 'auditor': 'Auditor', 'newswire': 'Newswire of habit'}, 'prefixes': ['KOSPI', 'KOSDAQ', 'KONEX'], 'alias_from_lei_record': True}
MAPS = {'ca': CA, 'uk': UK, 'au': AU, 'sg': SG, 'ch': CH, 'de': DE, 'fr': FR, 'nl': NL, 'jp': JP, 'kr': KR}
