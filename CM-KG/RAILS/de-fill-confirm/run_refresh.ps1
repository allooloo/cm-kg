# CM-KG rail — Germany passes 2 (Fill) and 3 (Confirm), run after the Width 1 weekly refresh (see CM-KG\RAILS\de-weekly.ps1). Pond-native; skips on the node lock.
$ErrorActionPreference = 'Continue'
Set-Location $PSScriptRoot
if (Test-Path 'C:\ALLOOLOO\CM-KG\POND\de-cm-kg\.lock') { 'de-cm-kg locked (build order in flight): refresh skipped'; exit 0 }
python ..\pond_open.py de-cm-kg de-fill-confirm fill-confirm
...
Step 'Width 1 assemble with the live layer' { Push-Location ..\de-width1; $env:WINDOW_DAYS = '7'; python assemble_disclosure.py; Pop-Location }
