# ORDER-016 Part B build-day chain (2026-09-11), France. Reading order per the CEO rule for the European nodes: Perplexity (Agent API, low) → Grok → Mistral
...
Step 'perplexity' { $env:THREADS = '4'; $env:PPLX_MAX = '600'; python perplexity_pages.py }
