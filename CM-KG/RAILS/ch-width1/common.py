"""Shared pieces for the Switzerland Width 1 (Disclosure) rail (ORDER-015 Part B). Same shape as the Singapore rail; Swiss issuers and sources.
...
sys.path.insert(0, r'C:\ALLOOLOO\CM-KG\RAILS\ch-width0')
...
TABS = ['SIX', 'BX Swiss']; TICKER_COL = 'Symbol'; REG_COL = 'UID (Zefix)'; HOME_ISIN = 'CH'
