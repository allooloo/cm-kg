...
- **Test on the Netherlands node, no wire search:** load + upload in **87 s wall time** (newest drop per source, 0 new blobs — already in the store; door records, events and index re-sent). The door had not yet shown the new stamp at the time of writing (booted=2026-09-13T13:19:09.467Z, unchanged); the refresh is on its ten-minute cycle — reported as pending.
